...
typedef struct {        /* solution type */
    ...
    double ddtr;        /* receiver clock drift of all systems (s) */
...
typedef struct {        /* processing options type */
    ...
    uint8_t stationType; /*1:rover 2:base*/
} prcopt_t;
...
EXPORT int pntpos_filter(const obsd_t *obs, const int n, const nav_t *nav, 
                         rtk_t *rtk);
